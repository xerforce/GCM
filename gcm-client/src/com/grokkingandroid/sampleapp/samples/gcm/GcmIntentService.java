...
import com.grokkingandroid.sampleapp.samples.alert.*;
...
public class GcmIntentService extends IntentService {
   ...
   protected void onHandleIntent(Intent intent) {
      mSenderId = getResources().getString(R.string.gcm_project_number);
...
//        	 String msg = extras.getString(Constants.KEY_MESSAGE_TXT);
        	 String msg = extras.getString("message");
        	 if(msg!=null){
        		 sendNotification(msg);
        		 showAlertListDialog(msg);
        	 }
         }
...
*/
   ...
   private void register(GoogleCloudMessaging gcm, Intent intent) {
      try {
         ...
         //Start to register the Device and return the regId.
   ...
   public void showAlertListDialog(final String msg) {
		handler.post(new Runnable() {
			@Override
			public void run() {
				// TODO Auto-generated method stub
				Intent alertIntent = new Intent(GcmIntentService.this,AlertListActivity.class);
				Bundle bl=new Bundle();
				bl.putString("msg", msg);
				alertIntent.putExtras(bl);				
				alertIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//				alertIntent.setAction("com.hmkcode.android.gcm.GcmMessageHandler");
